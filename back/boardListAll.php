<?php
	...
	$sql = "select count(*) as cnt from board where del_y='N' order by no desc";
...
<?php
	...
	$sql = "select * from board where del_y='N' order by no desc" . $sqlLimit; //원하는 개수만큼 가져온다. (0번째부터 20번째까지
	$result = $conn->query($sql);
