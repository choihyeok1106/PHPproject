                    ...
                    <div class="col-md-6">
                        <div class="c-container bg-green">
                            <div class="c-content-title-1 c-inverse">
                                ...
                                <p class="c-font-lowercase">Try visiting our FAQ page to learn more about our greatest ever expanding theme,
                                    Metronic.</p>
                                <a href="https://livepure.com/about-us" class="btn grey-cararra font-dark" target="_blank">Learn More</a>
                            </div>
                        </div>
                                ...
                                <form>
                                    <div class="input-group input-group-lg c-square">
                                        ...
                                        <span class="input-group-btn">
                                                    <button onclick="location.href='faq.php?q=question'" class="btn uppercase"
                                                            type="button">Go!</button>
                                                </span>
                                    </div>
                                </form>
                                <p>Ask your questions away and let our dedicated customer service help you look through our FAQs to get your questions
                                    answered!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="c-contact">
                            <div class="c-content-title-1">
                                ...
                                <div class="c-line-left bg-dark"></div>
                                <p class="c-font-lowercase">Our helpline is always open to receive any inquiry or feedback. Please feel free to drop
