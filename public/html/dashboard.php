...
<div class="row">
    ...
    <div class="col-lg-3 col-sm-6 d-flex flex-column">
        ...
        <div class="card social-card share share-other full-width m-b-10 d-flex flex-1 full-height no-border sm-vh-75" data-social="item">
            ...
            <div class="card-header clearfix">
                <div class="user-pic">
                    <img alt="Avatar" width="33" height="33" data-src-retina="/img/profiles/avatar_small2x.jpg" data-src="/img/profiles/avatar.jpg" src="/img/profiles/avatar_small2x.jpg">
                </div>
                <h5>David Nester</h5>
