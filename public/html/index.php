            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="note note-danger">
                        <button type="button" class="note-close close-button close" data-dismiss="modal" aria-hidden="true" style="margin-top: -10px;">×</button>
                    ...
                    <div class="grid-item-content">
                        <div class="portlet portlet-sortable light res-box" data-target="#widget-banner">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        <button type="button" id="summary-curr-btn" class="btn btn-circle btn-outline green btn-sm active">Current</button>
                                        <button type="button" id="summary-last-btn" class="btn btn-circle btn-outline green btn-sm">Last</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="timeline">
                                        <div class="events-wrapper">
                                            <div class="events">
                                                <ol>
                                                    <li>
                                                        <a href="#0" data-date="0/01/2014" class="border-after-red bg-after-red selected">Verbal 1</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="1/01/2014" class="border-after-red bg-after-red">Verbal 2</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="2/01/2014" class="border-after-red bg-after-red">Verbal 3</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="3/01/2014" class="border-after-red bg-after-red">Verbal 4</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="4/01/2014" class="border-after-red bg-after-red">Verbal 5</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="5/01/2014" class="border-after-red bg-after-red">Verbal 6</a>
                                                    </li>
                                                    <li>
                                                        <a href="#0" data-date="6/01/2014" class="border-after-red bg-after-red">Verbal 7</a>
                                                    </li>
                                                </ol>
                                                ...
                                                <li class="<?= $i == 0 ? 'selected' : null ?>" data-date="<?= $i ?>/01/2014">
                                                    ...
                                                    <div class="mt-author">
                                                        <div class="mt-author-name">
                                                            <a href="javascript:;" class="font-blue-madison"><?= $i + 1 ?>/7 Completed</a>
                                                        </div>
                                                    ...
                                                    <div class="mt-content border-grey-steel">
                                                        <p>
                                                            Good social skills are an important part of building rich friendships, enjoying yourself in public,
                                                            and succeeding in your career. If you consider yourself an introvert, it can be hard to engage in
                                                            conversation with people you don’t know.

                                                        </p>
                                                        <a href="javascript:;" class="btn btn-circle btn-outline btn-sm blue">View all Courses</a>
                                                    </div>
                                                </li>
                                            <?php } ?>
                                        </ol>
                                        ...
                                        <?php for ($i = 0; $i < 10; $i++) { ?>
                                           ...
                                           <span class="text-info">
                                            ...
                                            &nbsp;
                                                ...
                                                <div class="item-body"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
...
<script src="<?= STATIC_SERVER ?>/vendors/flexslider/jquery.flexslider.js?<?= v() ?>" type="text/javascript"></script>
...
<script src="<?= STATIC_SERVER ?>/vendors/horizontal-timeline/horizontal-timeline.js?<?= v() ?>" type="text/javascript"></script>
