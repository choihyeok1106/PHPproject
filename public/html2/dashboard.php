...
<div class="row">
    ...
    <div class="col-lg-3 col-sm-6 d-flex flex-column">
        ...
        <div class="card social-card share share-other full-width m-b-10 d-flex flex-1 full-height no-border sm-vh-75" data-social="item">
            ...
            <div class="card-content flex-1" data-pages-bg-image="/html2/img/social_new.jpg">
                <ul class="buttons ">
                    <li>
            ...
            <div class="card-header clearfix">
                <div class="user-pic">
                    <img alt="Avatar" width="33" height="33" data-src-retina="/html2/img/profiles/avatar_small2x.jpg" data-src="/html2/img/profiles/avatar.jpg" src="/html2/img/profiles/avatar_small2x.jpg">
                </div>
                <h5>David Nester</h5>
                    ...
                    <div class="bg-master-light padding-20 full-width ">
                        <div class="row">
                            ...
                            <div class="col-2 text-center">
                                <a href="#" class="block m-t-15"><img src="/html2/img/plus.svg"></a>
                            </div>
                        </div>
                    </div>
                </div>
