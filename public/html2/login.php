...
<div class="login-wrapper ">
    ...
    <div class="bg-pic">
        ...
        <div class="login-bg" style="background-image: url('https://livepure.com/html2/img/vidthumb.jpg')">
            <video id="heroVid" playsinline="" autoplay="" muted="" loop="">
                <source src="https://livepure.com/html2/img/vidhero2render.mp4" type="video/mp4">
