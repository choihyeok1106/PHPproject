...
var app = {
    /** @function Aside menu
     * @description open aside menu
     */
    initAside: function () {
        $('[data-toggle="aside-toggle"]').each(function () {
            ...
            if ($(target)) {
                $(this).on('click', function () {
                    ...
                    $('body').removeClass('aside-show').addClass('aside-show');
                });
                $(document).mouseup(function (e) {
                    if ($(e.target).parents(target).length == 0) {
                        $('body').removeClass('aside-show');
                    }
                });
                $('.asidemenu .asidemenu-item').on('click', function () {
    ...
    initResponse: function () {
        function initResponse() {
            $('[data-toggle="response-box"]').each(function () {
                ...
                if (a == true) {
                    ...
                    $(this).css('line-height', (height - t - b) + 'px');
                }
            });
        }
    ...
    initMathf: function () {
        $('[data-toggle="mathf-count"]').on('click', function () {
            var target = $(this).attr('data-target');
...
(function ($) {
    ...
    Pages.prototype.initHorizontalMenu = function () {
        ...
        $(document).mouseup(function (e) {
            if ($(e.target).parents('[data-pages-init="horizontal-menu"]').length == 0) {
                $("body").removeClass('horizontal-menu-open');
                $('[data-pages-init="horizontal-menu"]').removeClass('open');
                $('.horizontal-menu-backdrop').remove();
            }
        });

        function autoHideLi() {
            var isMobi = $(window).width() < 992;
            $('[data-pages-init="horizontal-menu"]>ul>li').each(function () {
                if (isMobi) {
                    if ($(this).hasClass('opening')) {
                        $(this).removeClass('opening').addClass('active');
                    }
                } else {
                    if ($(this).hasClass('active')) {
                        $(this).removeClass('active').addClass('opening');
                    }
                }
            });
            /*
...
(function (window) {
    ...
    SelectFx.prototype._createSelectEl = function () {
        ...
        this.selEl.innerHTML = '<span class="cs-placeholder">' + textContent + '</span>' + opts_el;
